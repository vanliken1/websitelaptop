                ...
                <div class="col-lg-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li aria-current="page" class="breadcrumb-item active">Laptop {{$sptheobrand[0]->thuonghieu->tenthuonghieu}}</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-lg-3">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="pages">
                        <nav aria-label="Page navigation example" class="d-flex justify-content-center">
                            <ul class="pagination">
                                <li>{{ $sptheobrand->appends(Request::all())->links() }}</li>
                            </ul>
                        </nav>
                    </div>
                </div>
