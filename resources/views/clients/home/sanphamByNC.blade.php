                ...
                <div class="col-lg-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li aria-current="page" class="breadcrumb-item active">{{$sptheonhucau[0]->loaisp->tenloai}}</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-lg-3">
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="product">
                                ...
                                <div class="text">
                                    ...
                                    @endif
                                    <p class="buttons"><a href="/chitiet/{{$item->slug_sanpham}}" class="btn btn-outline-secondary">Thông tin</a>
                                    <a class="btn btn-primary add-to-cart" data-id="{{$item->idsanpham}}"><i class="fa fa-shopping-cart"></i>Thêm vào giỏ</a></p>
