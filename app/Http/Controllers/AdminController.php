...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $donhangganday = Donhang::orderBy('ngaydat', 'DESC')
            ->take(5)
            ->get();
        $totalRevenue = Thongke::where('ngaydat', '<=', $today)
            ->sum('doanhthu');
        return view('admin.index', ['sanpham_count' => $sanpham_count, 'user_count' => $users_count, 'order_count' => $order_count, 'totalRevenue' => $totalRevenue, 'donhangganday' => $donhangganday]);
    }
